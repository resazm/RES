...
#全体分
df_5 = pd.read_excel("./月額_分割統合.xlsx", sheet_name="Sheet6", header=0, usecols="A:G")
...
#自社分
df_6 = pd.read_excel("./月額_分割統合.xlsx", sheet_name="Sheet7", header=0, usecols="A:G")
...
#全体・自社両方分
df_7 = pd.read_excel("./月額_分割統合.xlsx", sheet_name="Sheet8", header=0, usecols="A:G")
